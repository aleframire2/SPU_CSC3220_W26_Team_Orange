...
// DB-backed syllable lookup; falls back to heuristic.
...
// Returns 0 if text is empty. Pass db for accurate cmudict syllable counts.
double flesch_score(const std::string& text, sqlite3* db = nullptr);
